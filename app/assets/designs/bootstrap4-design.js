(function () {
    var designJSON = {
        ...
        "components": [
            ...
            {
                "name": "alert",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-alert-triangle" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M12 9v2m0 4v.01" /><path d="M5.07 19H19a2 2 0 0 0 1.75 -2.75L13.75 4a2 2 0 0 0 -3.5 0L3.25 16.25a2 2 0 0 0 1.75 2.75" /></svg>',
            ...
            {
                "name": "p",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-minus" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12" /></svg>',
            ...
            {
                "name": "buttonlink",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-minus" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="9" y1="12" x2="15" y2="12" /></svg>',
            ...
            {
                "name": "wysiwyg",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-columns" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="4" y1="6" x2="9.5" y2="6" /><line x1="4" y1="10" x2="9.5" y2="10" /><line x1="4" y1="14" x2="9.5" y2="14" /><line x1="4" y1="18" x2="9.5" y2="18" /><line x1="14.5" y1="6" x2="20" y2="6" /><line x1="14.5" y1="10" x2="20" y2="10" /><line x1="14.5" y1="14" x2="20" y2="14" /><line x1="14.5" y1="18" x2="20" y2="18" /></svg>',
                "html": "<div doc-wysiwyg=\"html\">Wyswiyg content</div>",
                "label": "WYSIWYG"
            },
            {
                "name": "quote",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-message-2" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20l-3 -3h-2a3 3 0 0 1 -3 -3v-6a3 3 0 0 1 3 -3h10a3 3 0 0 1 3 3v6a3 3 0 0 1 -3 3h-2l-3 3" /><line x1="8" y1="9" x2="16" y2="9" /><line x1="8" y1="13" x2="14" y2="13" /></svg>',
            ...
            },
            {
                ...
                "label": "Empty block",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" /></svg>',
                "properties": [
                    "display",
                    "position-relative",
                    "position-absolute",
            ...
            {
                "name": "section",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-new-section" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="12" x2="15" y2="12" /><line x1="12" y1="9" x2="12" y2="15" /><path d="M4 6v-1a1 1 0 0 1 1 -1h1m5 0h2m5 0h1a1 1 0 0 1 1 1v1m0 5v2m0 5v1a1 1 0 0 1 -1 1h-1m-5 0h-2m-5 0h-1a1 1 0 0 1 -1 -1v-1m0 -5v-2m0 -5" /></svg>',
            ...
            },
            {
                ...
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-rows" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="4" y1="12" x2="20" y2="12" /></svg>',
                "label": "Row",
                "properties": [
                    "display",
                    "position-relative",
            ...
            },
            {
                ...
                "label": "Column",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-columns" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"></rect><line x1="12" y1="4" x2="12" y2="20"></line></svg>',
                "allowedParents": [
                    "row",
                    "block"
                ],
            ...
            {
                "name": "cardlayout",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-cards" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="6" height="16" rx="2" /><rect x="14" y="4" width="6" height="10" rx="2" /></svg>',
            ...
            {
                "name": "card",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-bottombar" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="4" y1="15" x2="20" y2="15" /></svg>',
            ...
            {
                "name": "cardlink",
                "icon": '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#010101" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" /><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" /></svg>',
